...
\end{tikzpicture}
  \caption[Particles of The Standard Model.]{A table showing the particles of
    The Standard Model. The particles of matter, fermions, are shown on the left
    and the force carrying particles, bosons, are shown on the right.}
  \label{tab:sm}
\end{table}
