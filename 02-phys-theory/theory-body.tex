...
transition from their coloured states to colour singlets. Energy present in this
process results in the creation of lots of different states, some which decay to
leptons, with the overall process producing a roughly conical shower of
particles known as a jet.
...
\Hbb.
\input{02-phys-theory/cs-and-br}
