...
the sagitta the transverse momentum of the particle (denoted $p_{\mathrm{T}}$). An example
...
\input{03-detector/impact-params}
...
with having a detector that has good $p_{\mathrm{T}}$ resolution for electrons, positrons
and photons (muons go all the the way through the calorimeter anyway) due to the
process by which $p_{\mathrm{T}}$ is measured becoming more precise with a longer
