\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \tkzGetPoint{h}
    %\tkzDrawLine[add = 4 and 3](B,h)
    \tkzMarkRightAngle[size=0.2](O,B,h)
  \end{tikzpicture}
  \caption{A diagram showing the geometric construction of the sagitta ($S$) of a
    track. The track is comprised of a sequence of hits marked by crosses and the ``lever-arm''
