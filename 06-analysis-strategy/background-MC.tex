...
processes.]{Details of Monte Carlo simulated predictions of the
  background processes of the analysis. Here $\ell$ is inclusive of $e$, $\mu$
  and $\tau$ leptons. For $Z/\gamma^{*} \to \ell\ell$ events the requirement of
  $m_{\ell\ell}>40$~\GeV\ was imposed.}
\label{tab:bkgMC}
\end{table}
