...
\centering
\resizebox{\textwidth}{!}{
  \begin{tabular}{lllrS[table-format=3.2]S[table-format=3.2]S[table-format=3.2]}
    \toprule
    ...
    $t\bar{t}$ & non-full-had & \textsc{Powheg} + \textsc{Pythia 8} & $831.76\times0.543$ & 120(55) & 150(55) & 200(61) \\
                                            ...
                                            & di-leptonic & \textsc{Powheg} + \textsc{Pythia 8} & $831.76\times0.105$ & N/A & 45 & 100 \\
...
processes.]{Monte Carlo samples used for the background processes and the cross
  section times branching ratio (BR) used to normalise the different processes
  at $\sqrt{s}=13$~\TeV. The last column shows the number of simulated events
  for the {mc16a+d+e} production. Branching ratios correspond to the decays
  shown. In this table $\ell$ is inclusive of $e$, $\mu$, $\tau$ leptons. For
