\begin{table}[h!tbp]
  ...
  \centering
  \resizebox{\textwidth}{!}{
    \begin{tabular}{| l | C{1.7cm} | C{1.7cm} | C{1.9cm} | C{1.9cm} | C{1.3cm} |}
      \toprule
      \multirow{3}{*}{\bfseries Channel}  & \multicolumn{4}{c|}{\bfseries Categories}   \\
      \cline{3-8}
                                 &                         & \multicolumn{2}{c|}{\bfseries $\bm{75}$~\GeV$\bm{ < p_{\text{T}}^V < 150}$~\GeV} & \multicolumn{2}{c|}{\bfseries $p_{\text{T}}^V > 250~\GeV$} \\
      \cline{3-8}
