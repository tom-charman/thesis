...
backgrounds. Due to the flavour symmetry of the $t\bar{t}$ and $Wt$ processes
the shape of the top quark backgrounds in the top $e\mu$ control region and the
SR ought to be the same. In order to correct for any differences in
normalisation as scale factor is derived as follows
\begin{align}
  N_{\text{top, data}}^{\text{SR}}
  =
  \frac{N_{\text{top, data}}^{\text{CR}}}{N_{\text{top, MC}}^{\text{CR}}}
  \times
  N_{\text{top, MC}}^{\text{SR}}
  =
