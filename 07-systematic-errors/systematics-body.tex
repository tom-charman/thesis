...
In all regions the re-weighting is performed by comparing the ratio of the
nominal \textsc{Sherpa}~2.2.1 prediction with that of \textsc{MadGraph}. The
requirement of $p_T^V > 75$~\GeV is applied to all distributions in the
1--lepton channel and in the 0--lepton channel the requirement of
$E_T^{\text{miss}} > 150$~\GeV is imposed instead.
...
% %### HEAD ###
% %Prior the training, the nominal \SHERPA2.2.1 events are reweighted by the
% $p_T^V$  ratio with the alternative \MADGRAPH in each jet region and for each
% heavy flavour component. This ratio is exactly the one shown in blue in the
% bottom panel of Figure~\ref{fig:wjets_1lep_2jet_SysWPtVBDTr} and
% Figure~\ref{fig:wjets_1lep_3jet_SysWPtVBDTr} from which the $p_T^V$ shape
% uncertainty is derived through a linear fit. This allows to have a BDT shape
% systematic that does not account for the variance in $p_T^V$ .\\

% %Once the training and evaluation are performed for each jet category and
% heavy flavour pair, the ratio between the \SHERPA2.2.1 and \MADGRAPH BDT's
% distributions is found and used to define the BDTr-based systeamatic
% uncertainty. This is implemented in the fit as a nuisance parameter called
...
% \begin{figure}[H]
% \begin{center}
% \subfigure{\includegraphics[width=0.45\textwidth]{1Lep_BDTbased_closure/1lepton_2tag2jet_75ptv_SR+CR_pTV_bb.pdf}}  
% \subfigure{\includegraphics[width=0.45\textwidth]{1Lep_BDTbased_closure/1lepton_2tag2jet_75ptv_SR+CR_mBB_bb.pdf}}  \\
% \subfigure{\includegraphics[width=0.45\textwidth]{1Lep_BDTbased_closure/1lepton_2tag2jet_75ptv_SR+CR_Mtop_bb.pdf}} 
% \subfigure{\includegraphics[width=0.45\textwidth]{1Lep_BDTbased_closure/1lepton_2tag2jet_75ptv_SR+CR_dRBB_bb.pdf}} \\
...
% \begin{figure}[H]
% \begin{center}
% \subfigure{\includegraphics[width=0.45\textwidth]{0Lep_BDTbased_closure/0lepton_2tag2jet_150ptv_SR+CR_MET_bb.pdf}}  
% \subfigure{\includegraphics[width=0.45\textwidth]{0Lep_BDTbased_closure/0lepton_2tag2jet_150ptv_SR+CR_mBB_bb.pdf}}  \\
% \subfigure{\includegraphics[width=0.45\textwidth]{0Lep_BDTbased_closure/0lepton_2tag2jet_150ptv_SR+CR_dRBB_bb.pdf}} \\
...
% \begin{figure}[H]
% \begin{center}
% \subfigure{\includegraphics[width=0.45\textwidth]{1Lep_BDTbased_closure/1lepton_2tag2jet_75ptv_SR+CR_mvaFullRun2Default_bb.pdf}}  
% \subfigure{\includegraphics[width=0.45\textwidth]{1Lep_BDTbased_closure/1lepton_2tag3jet_75ptv_SR+CR_mvaFullRun2Default_bb.pdf}}  \\
...
% \begin{figure}[H]
% \begin{center}
% \subfigure{\includegraphics[width=0.45\textwidth]{0Lep_BDTbased_closure/0lepton_2tag2jet_150ptv_SR+CR_mvaFullRun2Default_bb.pdf}}  
% \subfigure{\includegraphics[width=0.45\textwidth]{0Lep_BDTbased_closure/0lepton_2tag3jet_150ptv_SR+CR_mvaFullRun2Default_bb.pdf}}
% \\
% \caption{Closure of BDTr-based systematic on the full Run 2 analysis MVA for
%   $W$+bb events in the 2tag2jet region (on the left) and 2tag3jet region (on the
