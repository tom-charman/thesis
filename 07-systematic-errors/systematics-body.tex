...
merging scale of $Q_{\text{cut}}=20$~\GeV\footnote{Q_{\text{cut}} describes the
  momentum sum above which the parton showering is used and below which the
  matrix element calculation is used.}. Simulation of events with more than 4
