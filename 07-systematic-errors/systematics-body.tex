...
tool~\cite{EgammaCalibTWiki}. Previous iterations of this
analysis have proven not to be very sensitive to these
quantities~\cite{vhbb-obs,Hbb2017:ATLAS} and therefore only two uncertainties
are considered which are called \texttt{EG\_RESOLUTION\_ALL} and
