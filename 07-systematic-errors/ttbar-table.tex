\begin{table}[hbpt!]
  \resizebox{\textwidth}{!}{
    \begin{tabular}{lllll}
      ...
      \texttt{SysBDTr\_ttbar\_ME\_J2} & \textsc{Powheg} to \textsc{MadGraph} $p_{\mathrm{T}}^V$-factorised BDTr shape  & $0/1$--lepton channels, 2--jet regions & - \\
      \texttt{SysBDTr\_ttbar\_ME\_J3} & \textsc{Powheg} to \textsc{MadGraph} $p_{\mathrm{T}}^V$-factorised BDTr shape & $0/1$--lepton channels, 3--jet regions & - \\
