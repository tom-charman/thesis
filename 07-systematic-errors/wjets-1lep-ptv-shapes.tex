\begin{figure}[ht!]
  ...
  \\
  \caption[Derivation of $p_T^V$ shape uncertainties on W + jets events in the
  1--lepton channel (2--jet category).]{$p_T^V$ shape systematic in the 2--jet
    category in the 1--lepton channel for each heavy flavour sub-component. The
    red and blue histograms correspond to the $p_T^V$ prediction of
    \textsc{Sherpa}~2.2.1 and \textsc{MadGraph} respectively. The $p_T^V$ shape
...
\begin{figure}[ht!]
  ...
  \\
  \caption[Derivation of $p_T^V$ shape uncertainties on W + jets events in the
  1--lepton channel (3--jet category).]{$p_T^V$ shape systematic in the 3--jet
    category in the 1--lepton channel for each heavy flavour sub-component. The
    red and blue histograms correspond to the $p_T^V$ prediction of
    \textsc{Sherpa}~2.2.1 and \textsc{MadGraph} respectively. The $p_T^V$ shape
    systematic is plotted in green.}
