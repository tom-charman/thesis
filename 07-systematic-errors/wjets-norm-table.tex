\begin{table}[!htb]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{llS[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]}
      ...
      \midrule
      {\bfseries 0-Lepton} & & & & & & & \\
      {\texttt{SysWbbNorm\_L0}}    & W+hf   &  5\% &  5\% & --  &  -- & -- & --    \\
      {\texttt{SysWbbCRSRextrap}}        & W+hf   &   -7.7\% &  -- & 14.9\%  &  -5.6\% & -- & 7.0\%    \\
      {\bfseries 1-Lepton} & & & & & & & \\
      {\texttt{SysWclNorm}}             & W+l    &   \multicolumn{6}{ c }{   32\% } \\
      {\texttt{SysWlNorm}}              & W+cl   &   \multicolumn{6}{ c }{  37\%  }\\
      {\texttt{norm\_Wbb\_J2}}           & W+hf   &   \multicolumn{3}{ c }{ Floating Normalisation} & -- & -- & -- \\
      {\texttt{norm\_Wbb\_J3}}           & W+hf   &  -- & -- & -- & \multicolumn{3}{ c }{ Floating Normalisation} \\
      {\texttt{SysWbbCRSRextrap}}        & W+hf   &   -11.5\% &  -- & 14.8\%  &  -3.6\% & -- & 5.1\%    \\
      \bottomrule
    \end{tabular}
  }
