\begin{table}
  ...
  \resizebox{\linewidth}{!}{
    \begin{tabular}{lS[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]}
      \toprule   
      {\bfseries Region ($\bm{p^{V}_{\mathrm{T}}}$ range)} & {\bfseries CR$_{\text{low}$ (\texttt{SysZPtv} \%)} & {\bfseries SR (\texttt{SysZPtv} \%)} & {\bfseries CR$_{\text{high}$ (\texttt{SysZPtv} \%)} & {\bfseries  Weighted Sum $\bm{p^{V}_{\mathrm{T}}}$ (\%)} & {\bfseries $\bm{\Delta}$(SR - CR$_{\text{low}$)} & {\bfseries $\bm{\Delta}$(CR$_{\text{high}$, SR)} \\
      \midrule
  ...
  uncertainty.]{SysZPtv shape effect}
    ...
    % [CR$_{\text{low}$,SR,CR$_{\text{high}$] fit regions of the
    % analysis.
    ...
    % systematic across the  [CR$_{\text{low}$,SR,CR$_{\text{high}$] fit regions of the
    % analysis.
