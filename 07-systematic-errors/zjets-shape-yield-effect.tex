\begin{table}[hb]
  ...
  \resizebox{\linewidth}{!}{
    \begin{tabular}{lS[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]S[table-format=3.2]}
      \toprule   
      {\bfseries Region} & {\bfseries CR$_{\text{low}}$ } & {\bfseries SR } & {\bfseries CR$_{\text{high}}$} & {\bfseries  Weighted Sum $\bm{p^{V}_{\mathrm{T}}}$ (\%)} & {\bfseries $\bm{\Delta}$(SR, CR$_{\text{low}}$)} & {\bfseries $\bm{\Delta}$(CR$_{\text{high}}$, SR)} \\
      \midrule
