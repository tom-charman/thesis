\begin{table}
  \resizebox{\textwidth}{!}{
    \begin{tabular}{lllll}
      ...
      \texttt{SysZbbCRSRextrap\_BMin75\_L2\_CRLow} & Uncertainty on SR to CRLow $Z$+jets extrapolation & Z+jets, CRLow  $p_{\mathrm{T}}^V\in[75,150[~\GeV$ & 3.8\%-9.9\% & Normalization\\
