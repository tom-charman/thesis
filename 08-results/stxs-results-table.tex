  ...
  \centering
    \resizebox{\textwidth}{!}{
      \begin{tabular}{lrrrrrr}
        \toprule
        {\bfseries Process} & {\bfseries $p_{\mathrm{T}}^V$ bin} {\bfseries SM prediction}  & {\bfseries Result} & {\bfseries Stat. unc.} & \multicolumn{3}{c}{\bfseries Syst. unc.} \\
                           &                   &           &               & Th. sig. & Th. bkg.  & Exp. \\
        \midrule
    ...
    \caption{caption, ($|y_H|<2.5$, $H\to b\bar{b}$), all quantities in fb}
